...
<body>
    ...
    <div class="form">
        <form action="editar-upload.php" method="post" enctype="multipart/form-data">
            <input type="hidden" name="id" value="<?php echo $campo['id']; ?>">
            <label for="nome">Nome:</label>
            <input id="nome" type="text" name="nome" placeholder="Digite seu nome" maxlength="60" required value="<?php echo $campo['nome']; ?>">
            <label for="email">Email:</label>
            <input id="email" type="email" name="email" placeholder="Digite seu email" maxlength="100" required value="<?php echo $campo['email']; ?>"><br>
